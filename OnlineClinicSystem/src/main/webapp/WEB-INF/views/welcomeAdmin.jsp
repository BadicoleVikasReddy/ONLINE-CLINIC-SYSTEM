...
<header class="header">
    ...
    <nav class="navbar">
        <a href="#home"><i class="fa fa-home fa-fw" aria-hidden="true"></i>Admin</a>
        <a href="#services"><i class="fa fa-hospital-o" aria-hidden="true"></i>
        services</a>
        <a href="#about"><i class="fa fa-user" aria-hidden="true"></i>
        about</a>
        <a href="/AdminLogout"><i class="fa fa-sign-in" aria-hidden="true"></i>
        Logout</a>
    </nav>
...
<a href="/ChangeAdminPassword " class="btn"> Change Password
			 <span class="fas fa-chevron-right"></span>
			</a>	&nbsp;&nbsp;&nbsp;&nbsp;
			
		<a href="/AddDoctorDetails" class="btn"> Add doctor Details  <span
				class="fas fa-chevron-right"></span></a> &nbsp;&nbsp;&nbsp;&nbsp;
				<a href="/ModifyDoctorDetails" class="btn"> modify doctor details  <span
				class="fas fa-chevron-right"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="/DeleteDoctorDetails" class="btn"> Delete doctor Details  <span
				class="fas fa-chevron-right"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="/ViewDoctorDetails" class="btn"> View doctor Details  <span
				class="fas fa-chevron-right"></span></a>
