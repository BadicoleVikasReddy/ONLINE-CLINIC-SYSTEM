...
%>
	<header class="header">
		...
		<nav class="navbar">
			<a href="#home"><i class="fa fa-home fa-fw" aria-hidden="true"></i>User</a>
			<a href="#services"><i class="fa fa-hospital-o"
				aria-hidden="true"></i> services</a> <a href="#about"><i
				class="fa fa-user" aria-hidden="true"></i> about</a> <a
				href="/UserLogout"><i class="fa fa-sign-in" aria-hidden="true"></i>
				Logout</a>
		</nav>
	...
	<section class="home" id="home">
		...
		<div class="content">
			...
			<a href="/ChangeUserPassword " class="btn"> Change Password <span
				class="fas fa-chevron-right"></span>
			</a> <a href="/EditRegistrationDetails" class="btn"> Edit
				Registration Details <span class="fas fa-chevron-right"></span>
			</a> <a href="/ViewRegistrationDetails" class="btn">View Registration
				Details <span class="fas fa-chevron-right"></span>
			</a> <a href="/ViewAppointmentDetails" class="btn"> View Appointment
				History <span class="fas fa-chevron-right"></span>
			</a> <a href="/RequestForAppointment" class="btn">Appointment<span
